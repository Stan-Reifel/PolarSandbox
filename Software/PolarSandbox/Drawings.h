...
extern int drawTriangleShells(boolean direction);
...
extern int drawNonagonStars(void);
...
extern int drawSineTwisted(boolean direction);
extern int drawSinewaveHD(boolean direction);
extern int drawHexiClippedSine_SpiderWeb(boolean direction);
extern int drawHeptaClippedSine(boolean direction);
extern int drawOctaClippedSine(boolean direction);
extern int drawBiClippedSine(boolean direction);
